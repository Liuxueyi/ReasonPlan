...
class QformerMap(nn.Module):
    def __init__(self, vision_width, num_query_token):
        super().__init__()
        self.Qformer, self.query_tokens, self.ln_vision = self.build_Qformer(vision_width, 1, num_query_token)
    ...
    def config(self):
        return {
            ...
            "mm_qformer_depth": 2,
            "mm_qformer_latents": 100,
            "mm_qformer_pretrained": False,
        }
